/**
 * seed-inicio-pesca.js — v2
 * Cria o Módulo Início completo na Rota da Pesca.
 * Campos corretos: parent, title, body, grade
 *
 * Uso: node scripts/seed-inicio-pesca.js
 */
...
async function main() {
    console.log('🐟 Seed — Rota da Pesca: Módulo Início (v2)');
    console.log('============================================\n');
    ...
    console.log('\n\n✅ Módulo Início — Rota da Pesca criado!');
